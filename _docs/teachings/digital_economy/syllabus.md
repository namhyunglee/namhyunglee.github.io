...
강의안으로 수업을 진행하며, [U-KNOU 캠퍼스 홈페이지]((https://ucampus.knou.ac.kr/ekp/user/course/initUCRCourse.sdo?sbjtId=KNOU0911001&cntsId=KNOU0911){:target="_blank"}) 과목 자료실에 강의안과 프리젠테이션이 업로드 되어 있다.
...
1. 학교 홈페이지 [https://www.knou.ac.kr](https://www.knou.ac.kr){:target="_blank"} 로그인 
→ 맞춤 정보 보기 
→ 나의 수강 정보 '학습하기' 클릭 
...
2. U-KNOU 캠퍼스 홈페이지 [https://ucampus.knou.ac.kr/](https://www.knou.ac.kr){:target="_blank"} 로그인 
→ 학습목록에서 "디지털 경제의 이해" 선택
→  '강의자료실' 선택
